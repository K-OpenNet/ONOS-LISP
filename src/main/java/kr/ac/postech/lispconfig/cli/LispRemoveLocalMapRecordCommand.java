 ...
 */
@Command(scope = "onos", name = "lisp-remove-local-eid",
         description = "remove local eid-rloc database on the device")

public class LispRemoveLocalMapRecordCommand extends AbstractShellCommand {
    ...
    protected void execute() {
        ...
        service.removeEtrEidDataBase(deviceId, builder.build());
    }
}
