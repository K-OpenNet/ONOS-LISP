 ...
 */
@Command(scope = "onos", name = "lisp-get-map-resolver",
         description = "get map resolver configuration information")

public class LispGetMapResolverCommand extends AbstractShellCommand {
    ...
    protected void execute() {
        ...
        String result = service.getConfigWithFilter(deviceId, ITR_CFG);
        print(result);
    }
}
